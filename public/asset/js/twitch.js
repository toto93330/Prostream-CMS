    ...
    return function () {
                ...
                729: function (e) {
                    ...
                    Object.create && (r.prototype = Object.create(null), (new r).__proto__ || (n = !1)), l.prototype.eventNames = function () {
                        ...
                        if (c.fn) {
                            ...
                            for (u = 1, s = new Array(p - 1); u < p; u++) s[u - 1] = arguments[u];
                        ...
                        if (l.fn) l.fn !== t || o && !l.once || r && l.context !== r || a(this, i);
                        else {
                            for (var s = 0, u = [], c = l.length; s < c; s++)(l[s].fn !== t || o && !l[s].once || r && l[s].context !== r) && u.push(l[s]);
        ...
        return function () {
            ...
            ***************************************************************************** */
            ...
            function g(e, t) {
                var n = "https://" + t + ".twitch.tv" + "?" + m.Pz(o(o({}, e), {
                        parent: b(e.parent),
                        referrer: document.location.href
                    })),
                    r = document.createElement("iframe");
                r.setAttribute("src", n), r.setAttribute("allowfullscreen", ""), r.setAttribute("scrolling", "no"), r.setAttribute("frameborder", "0"), r.setAttribute("allow", "autoplay; fullscreen"), r.setAttribute("title", "Twitch");
                var i = "allow-modals allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox";
                return "function" == typeof document.hasStorageAccess && "function" == typeof document.requestStorageAccess && (i += " allow-storage-access-by-user-activation"), r.setAttribute("sandbox", i), e.width && r.setAttribute("width", String(e.width)), e.height && r.setAttribute("height", String(e.height)), r
            }
            ...
            var _ = {
                ...
                E = function (e) {
                    ...
                    return t(n, e), n.prototype._setWindowRef = function (e) {
                        ...
                        this._sendCommand(s.DisableCaptions, null)
                    }, n.prototype.enableCaptions = function () {
                        this._sendCommand(s.EnableCaptions, null)
                    }, n.prototype.pause = function () {
                        this._sendCommand(s.Pause, null)
                    }, n.prototype.play = function () {
                        this._sendCommand(s.Play, null)
                    }, n.prototype.seek = function (e) {
                        this._sendCommand(s.Seek, e)
                    }, n.prototype.setChannel = function (e) {
                        this._sendCommand(s.SetChannel, e)
                    }, n.prototype.setChannelId = function (e) {
                        this._sendCommand(s.SetChannelID, e)
                    }, n.prototype.setCollection = function (e, t) {
                        this._sendCommand(s.SetCollection, [e, t])
                    }, n.prototype.setQuality = function (e) {
                        this._sendCommand(s.SetQuality, e)
                    }, n.prototype.setVideo = function (e) {
                        this._sendCommand(s.SetVideo, e)
                    }, n.prototype.setMuted = function (e) {
                        var t = "boolean" != typeof e || e;
                        this._sendCommand(s.SetMuted, t)
                    }, n.prototype.setVolume = function (e) {
                        this._sendCommand(s.SetVolume, e)
                ...
                P = function (e) {
                    ...
                    }, n.AUTHENTICATE = l.AUTHENTICATE, n.CAPTIONS = l.CAPTIONS, n.ENDED = l.ENDED, n.ERROR = l.ERROR, n.OFFLINE = l.OFFLINE, n.ONLINE = l.ONLINE, n.PAUSE = l.PAUSE, n.PLAY = l.PLAY, n.PLAYBACK_BLOCKED = l.PLAYBACK_BLOCKED, n.PLAYING = l.PLAYING, n.VIDEO_PAUSE = l.VIDEO_PAUSE, n.VIDEO_PLAY = l.VIDEO_PLAY, n.VIDEO_READY = l.VIDEO_READY, n.READY = l.READY, n.SEEK = l.SEEK, n.Errors = o({
                        ABORTED: p.Aborted,
                        NETWORK: p.Network,
                        DECODE: p.Decode,
